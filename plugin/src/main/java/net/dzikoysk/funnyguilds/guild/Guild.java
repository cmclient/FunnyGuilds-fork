...
public class Guild extends AbstractMutableEntity {
    ...
    private transient ItemStack[] vault;
    ...
    private boolean pvp;
    private transient boolean vaultOpened;
    ...
    public boolean isVaultOpened() {
        return this.vaultOpened;
    }

    public void setVaultOpened(boolean vaultOpened) {
