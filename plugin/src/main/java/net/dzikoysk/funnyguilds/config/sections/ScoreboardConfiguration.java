...
public class ScoreboardConfiguration extends OkaeriConfig {
    ...
    public static class NameTag extends OkaeriConfig {
        ...
        @Comment("")
        @Comment("Konfiguracja kolorów nicku")
        public Map<String, String> nameColors = new LinkedHashMap<String, String>() {{
            put("op", "&5");
            put("funnyguilds.color.root", "&4");
            put("funnyguilds.color.admin", "&c");
            put("funnyguilds.color.moderator", "&2");
            put("funnyguilds.color.vip", "&e");
        }};
