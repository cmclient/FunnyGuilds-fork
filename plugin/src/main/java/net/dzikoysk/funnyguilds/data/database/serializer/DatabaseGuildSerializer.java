...
import net.dzikoysk.funnyguilds.shared.SerializeUtils;
...
public final class DatabaseGuildSerializer {
    ...
    public static Option<Guild> deserialize(ResultSet resultSet) {
        ...
        try {
            ...
            ItemStack[] vault = SerializeUtils.deserialize(resultSet.getString("vault"));
    ...
    public static void serialize(Guild guild) {
        ...
        statement.set("info", "");
        statement.set("vault", SerializeUtils.serialize(guild.getVault()));
